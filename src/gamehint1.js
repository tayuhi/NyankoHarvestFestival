...
var ThirdLayerhint1 = cc.Layer.extend({
    ...
    ctor: function() {
        ...
        //画像
        var sprite = cc.Sprite.create(res.howtoplay1_J);
...
*/
    ...
    onTouchEnded: function(touch, event) {
        cc.director.runScene(new hintScene2());
...
var hintScene1 = cc.Scene.extend({
    onEnter: function() {
        this._super();
        ...
        //ラベルとタップイベント取得
        var layer4 = new ThirdLayerhint1();
